    ...
    <form method="post" name="cleanup_options" action="options.php">
        ...
        <div class="postbox">
            <div class="inside">
                ...
                <!-- Privacy Policy URL -->
                <div>
                    <label for="<?php echo $this->plugin_name; ?>-privacy_policy_url">Privacy Policy URL</label>
                    <fieldset>
                        <input type="url" class="regular-text" id="<?php echo $this->plugin_name; ?>-privacy_policy_url"
                               name="<?php echo $this->plugin_name; ?>[privacy_policy_url]"
                               placeholder="#"
                               value="
								<?php
						       ...
						       ?>
							   "/>
                        <span><?php esc_attr_e( 'Custom URL that points to your Privacy Policy page', $this->plugin_name ); ?></span>
                    </fieldset>
                </div>
